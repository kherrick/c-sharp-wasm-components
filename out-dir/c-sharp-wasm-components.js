...
function add(arg0, arg1) {
  _debugLog('[iface="components:c-sharp-wasm-components/utilities@0.1.0", function="add"] [Instruction::CallWasm] (async? false, @ enter)');
  const _wasm_call_currentTaskID = startCurrentTask(0, false, 'utilities010Add');
  const ret = utilities010Add(toUint32(arg0), toUint32(arg1));
  endCurrentTask(0);
  _debugLog('[iface="components:c-sharp-wasm-components/utilities@0.1.0", function="add"][Instruction::Return]', {
    funcName: 'add',
    paramCount: 1,
    postReturn: false
  });
...
const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./c-sharp-wasm-components.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./c-sharp-wasm-components.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    utilities010Add = exports1['components:c-sharp-wasm-components/utilities@0.1.0#add'];
  })();
...
export { utilities010 as utilities, utilities010 as 'components:c-sharp-wasm-components/utilities@0.1.0',  }